...
public final class PolyCurveSegment_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(srcl_lcm_msgs.PolyCurveSegment_t.class))
            return 0L;
 
        classes.add(srcl_lcm_msgs.PolyCurveSegment_t.class);
    ...
    public static srcl_lcm_msgs.PolyCurveSegment_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        srcl_lcm_msgs.PolyCurveSegment_t o = new srcl_lcm_msgs.PolyCurveSegment_t();
    ...
    public srcl_lcm_msgs.PolyCurveSegment_t copy()
    {
        srcl_lcm_msgs.PolyCurveSegment_t outobj = new srcl_lcm_msgs.PolyCurveSegment_t();

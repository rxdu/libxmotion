...
public final class Point3Df_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(srcl_lcm_msgs.Point3Df_t.class))
            return 0L;
 
        classes.add(srcl_lcm_msgs.Point3Df_t.class);
    ...
    public static srcl_lcm_msgs.Point3Df_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        srcl_lcm_msgs.Point3Df_t o = new srcl_lcm_msgs.Point3Df_t();
    ...
    public srcl_lcm_msgs.Point3Df_t copy()
    {
        srcl_lcm_msgs.Point3Df_t outobj = new srcl_lcm_msgs.Point3Df_t();
        outobj.x = this.x;

...
import srcl_lcm_msgs.Keyframe_t
...
class KeyframeSet_t(object):
    ...
    def __init__(self):
        self.kf_num = 0
        self.kfs = []
        self.sys_time = srcl_lcm_msgs.TimeStamp_t()
        self.path_id = 0
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.kf_num):
            assert self.kfs[i0]._get_packed_fingerprint() == srcl_lcm_msgs.Keyframe_t._get_packed_fingerprint()
            self.kfs[i0]._encode_one(buf)
        assert self.sys_time._get_packed_fingerprint() == srcl_lcm_msgs.TimeStamp_t._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.kfs = []
        for i0 in range(self.kf_num):
            self.kfs.append(srcl_lcm_msgs.Keyframe_t._decode_one(buf))
        self.sys_time = srcl_lcm_msgs.TimeStamp_t._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x7e244a5374dace1f+ srcl_lcm_msgs.Keyframe_t._get_hash_recursive(newparents)+ srcl_lcm_msgs.TimeStamp_t._get_hash_recursive(newparents)) & 0xffffffffffffffff

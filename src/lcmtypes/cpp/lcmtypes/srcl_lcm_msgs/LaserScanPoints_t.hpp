...
#ifndef __srcl_lcm_msgs_LaserScanPoints_t_hpp__
#define __srcl_lcm_msgs_LaserScanPoints_t_hpp__

#include <vector>
#include "lcmtypes/srcl_lcm_msgs/Pose_t.hpp"
#include "lcmtypes/srcl_lcm_msgs/Point3Df_t.hpp"
#include "lcmtypes/srcl_lcm_msgs/QuadrotorTransform.hpp"
...
{
    public:
        srcl_lcm_msgs::Pose_t trans_sensor2world;

        int64_t    point_num;

        std::vector< srcl_lcm_msgs::Point3Df_t > points;

        srcl_lcm_msgs::QuadrotorTransform pose;
...
uint64_t LaserScanPoints_t::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0x41cb5b1499974f70LL +
         ...
         srcl_lcm_msgs::Point3Df_t::_computeHash(&cp) +
         srcl_lcm_msgs::QuadrotorTransform::_computeHash(&cp);

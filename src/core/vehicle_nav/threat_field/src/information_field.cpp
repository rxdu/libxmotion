...
InformationField::InformationField(int64_t size_x, int64_t size_y)
    : ScalarField(size_x, size_y)
{
}

void InformationField::LoadEgoCenteredBasisPattern(int32_t radius_step_size, double angle_step_size, double sigma)
{
  int32_t basis_id = 0;
...
void InformationField::LoadUniformBasisPattern(int32_t x_step, int32_t y_step, double sigma)
{
  int32_t basis_id = 0;
...
void InformationField::AddThreatBasisField(int32_t id, std::shared_ptr<ThreatBasis> tfield)
{
...
std::shared_ptr<ThreatBasis> InformationField::GetThreatBasisField(int32_t id)
{
...
void InformationField::RemoveThreatBasisField(int32_t id)
{
  threat_basis_fields_.erase(id);
}

void InformationField::UpdateInformationField()
{
...
void InformationField::UpdateInformationField(std::vector<FieldObject> objects)
{

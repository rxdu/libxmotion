...
int main()
{
    ...
    GeometryViz::DrawDistribution(canvas, 60, 30, 40, 40, GaussianPositionThreat(60, 30, 5, 5));
    GeometryViz::DrawDistribution(canvas, 30, 60, 40, 20, GaussianPositionThreat(30, 60, 5, 2));
    GeometryViz::DrawDistribution(canvas, 80, 60, 20, 20, GaussianPositionThreat(80, 60, 2, 2));
    GeometryViz::DrawDistribution(canvas, 30, 20, 20, 20, GaussianPositionThreat(30, 20, 2, 2));

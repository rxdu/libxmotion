...
#include "trajectory/path_manager.hpp"

using namespace librav;

PathManager::PathManager(std::shared_ptr<lcm::LCM> lcm) : lcm_(lcm),
														  user_path_id_(0)
{
	lcm_->subscribe("quad_planner/goal_waypoints", &PathManager::LcmWaypointsHandler, this);

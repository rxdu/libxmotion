...
#include "messenger/can_messenger.hpp"
#include "messenger/lcm_messenger.hpp"
#include "messenger/lcm_channels.hpp"
...
#ifdef ENABLE_CSV_LOGGING
        spd_logger_->LogData(msg.time_stamp, msg.speed_estimate, msg.speed_estimate);
#endif

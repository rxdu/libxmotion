...
if(FLTK_BUILT_WITH_CMAKE)
  ...
  set(FLTK_CAIRO_LIBRARY fltk_cairo)
  ...
  if(NOT FLTK_CAIRO_LIBRARY)
      find_library(FLTK_IMAGES_LIBRARY_RELEASE NAMES fltkcairo fltk_cairo PATHS ${FLTK_LIBRARY_SEARCH_PATH} PATH_SUFFIXES fltk fltk/lib)
      find_library(FLTK_IMAGES_LIBRARY_DEBUG NAMES fltkcairod fltk_cairod PATHS ${FLTK_LIBRARY_SEARCH_PATH} PATH_SUFFIXES fltk fltk/lib)
      select_library_configurations(FLTK_CAIRO)
  endif()
...
if(NOT FLTK_SKIP_CAIRO)
  list(APPEND FLTK_LIBRARIES ${FLTK_CAIRO_LIBRARY})
endif()

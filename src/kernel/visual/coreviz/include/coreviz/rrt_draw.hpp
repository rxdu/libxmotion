...
struct RRTDraw
{
    ...
    static void DrawTree(CvCanvas &canvas, TreeType *tree)
    {
    ...
    static void DrawStraightBranch(CvCanvas &canvas, StateType *start, StateType *end)
    {
    ...
    template <typename StateType>
    static void DrawStraightPath(CvCanvas &canvas, std::vector<StateType *> path)
    {

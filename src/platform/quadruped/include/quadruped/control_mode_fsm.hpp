...
using StateVariant =
    std::variant<FixedStandMode, LyingDownMode, SwingTestMode, FreeStandMode,
                 BalanceTestMode, MoveBaseMode, PassiveMode, TrottingMode>;
...
struct ModeTransition {
  ...
  static OptionalStateVariant Transit(BalanceTestMode &state,
                                      ControlContext &context);
};
...
using ControlModeFsm =
    FiniteStateMachine<ControlContext, ModeTransition, FixedStandMode,
                       ...
                       BalanceTestMode, MoveBaseMode, PassiveMode,
                       TrottingMode>;
}  // namespace xmotion

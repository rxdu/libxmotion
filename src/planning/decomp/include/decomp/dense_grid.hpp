...
public:
  ...
  inline void SetValueAtCoordinate(int64_t x, int64_t y, double val) { SetTileAtGridCoordinate(x, y, val); }
  ...
  inline std::shared_ptr<SquareGrid> ConvertToSquareGrid(int32_t side_length, double threshold = 0)
  {

#include "xmnavigation/geometry/geometry_draw.hpp"
...
int main()
{
    ...
    GeometryViz::DrawPolygonDirection(canvas, trans1);
    GeometryViz::FillPolygon(canvas, trans2);
    GeometryViz::DrawPolygon(canvas, trans2, true, CvColors::red_color);

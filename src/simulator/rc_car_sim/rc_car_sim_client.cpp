...
RCCarSimClient::RCCarSimClient() : RobotSimClient<DataFromRCCarSim, DataToRCCarSim>()
{
...
bool RCCarSimClient::ReceiveDataFromRobot(DataFromRCCarSim &rx_data)
{
...
void RCCarSimClient::SendDataToRobot(const DataToRCCarSim &rcmd)
{

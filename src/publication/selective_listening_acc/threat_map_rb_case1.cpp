...
int main()
{
    ...
    auto ego_chn = traffic_map->GetTrafficChannel("s5", "s4");
    ...
    RoadMapViz::ShowCollisionFieldWithTrafficFlows(ego_polygon, cfield, &ego_flow, conflicting_flows, 10, "threat_field_roundabout1", true);

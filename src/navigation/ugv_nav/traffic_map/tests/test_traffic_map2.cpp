...
int main()
{
    ...
    // auto chn = traffic_map->GetTrafficChannel("s5", "s1");
    // RoadMapViz::ShowVehicleFootprints(chn.lane_blocks, 8, "dbg-decomp", true);
    ...
    // auto chns = traffic_map->FindConflictingChannels("s5", "s4");

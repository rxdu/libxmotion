...
/****************************************************************/
GaussianVelocityThreat::GaussianVelocityThreat(double vel_x, double vel_y, double sigma1, double sigma2) : vel_x_(vel_x),
                                                                                                           vel_y_(vel_y),
                                                                                                           sigma_1_(sigma1),
                                                                                                           sigma_2_(sigma2)
{
    // update coeff1_ and coeff2_
    SetParameters(vel_x, vel_y, sigma1, sigma2);
}

void GaussianVelocityThreat::SetParameters(double vel_x, double vel_y, double sigma1, double sigma2)
{
    vel_x_ = vel_x;
    vel_y_ = vel_y;
    sigma_1_ = sigma1;
...
{
    double x_err = x - vel_x_;
    double y_err = y - vel_y_;

...
// void DynamicThreatModel::ComputeOccupancyDistribution(int32_t k, bool calc_interval_dist)
// {
//     assert(k > 0);
...
// DynamicThreatModel::ThreatDist DynamicThreatModel::GetOccupancyDistributionAt(int32_t t_k)
// {
...
// DynamicThreatModel::ThreatDist DynamicThreatModel::GetIntervalOccupancyDistributionAt(int32_t t_k)
// {
//     ThreatDist dist_result;
...
// double DynamicThreatModel::operator()(double x, double y, int32_t t_k)
// {
...
// Point2d DynamicThreatModel::GetThreatCenter(int32_t t_k)
// {
//     // assert(t_k < threat_record_.size());
...
// double DynamicThreatModel::GetVehicleTotalThreat(double x, double y, int32_t t_k)
// {
//     auto threats = threat_record_[t_k].sub_threats;
//     double threat = 0.0;
//     for (auto &sub : threats)
...
// double DynamicThreatModel::operator()(double x, double y)
// {
//     double threat = 0.0;
...
// Point2d DynamicThreatModel::GetThreatCenter()
// {

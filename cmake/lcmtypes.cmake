...
function(lcmtypes_build_c)
    ...
    set(_lcmtypes_c_dir ${PROJECT_SOURCE_DIR}/src/lcmtypes/c/lcmtypes)
    ...
    include_directories(BEFORE ${PROJECT_SOURCE_DIR}/src/lcmtypes/c) #TODO: don't think this is necessary
    ...
    lcmtypes_add_clean_dir("${PROJECT_SOURCE_DIR}/src/lcmtypes/c")
endfunction()
...
function(lcmtypes_build_cpp)
    ...
    set(_lcmtypes_cpp_dir ${PROJECT_SOURCE_DIR}/src/lcmtypes/cpp/lcmtypes)
    ...
    include_directories(BEFORE ${PROJECT_SOURCE_DIR}/src/lcmtypes/cpp) #TODO: don't think this is necessary
    include_directories(${LCM_INCLUDE_DIRS})
    ...
    lcmtypes_add_clean_dir("${PROJECT_SOURCE_DIR}/src/lcmtypes/cpp")
endfunction()
...
function(lcmtypes_build_python)
    ...
    set(_lcmtypes_python_dir ${PROJECT_SOURCE_DIR}/src/lcmtypes/python)
    set(auto_manage_files YES)

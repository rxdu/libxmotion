...
> **[xmBase](https://github.com/rxdu/xmBase)** (foundation/common) and
> **[xmDriver](https://github.com/rxdu/xmDriver)** (host hardware drivers). Until the Phase-2 decoupling,
> `xmNavigation` builds standalone exactly as before. See the umbrella's

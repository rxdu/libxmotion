...
//	keyframe_x_vals(1,3) = 0;
	...
	keyframe_y_vals(0,0) = -0.15;
	keyframe_y_vals(0,1) = 0.25;
	keyframe_y_vals(0,2) = 0.3;
	keyframe_y_vals(0,3) = 0.35;

	keyframe_z_vals(0,0) = -0.15;
	keyframe_z_vals(0,1) = 0.25;
	keyframe_z_vals(0,2) = 0.3;
	keyframe_z_vals(0,3) = 0.35;

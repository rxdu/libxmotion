/*! \file components/extenders/quadrotor.h
...
namespace smp {
    ...
    /*!
      ...
      \ingroup states
    */
    class state_quadrotor : public state_array_double <3> {
    ...
    /*!
      ...
      \ingroup inputs
    */
    class input_quadrotor : public input_array_double<2> {
    ...
    */
    ...
    class extender_quadrotor : public extender_base<typeparams> {

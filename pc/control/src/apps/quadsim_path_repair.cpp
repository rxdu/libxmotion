...
//	controller->SetInitPose(-1.8,1.2,0.6,-M_PI/4);
//	controller->SetInitPose(-1.8,0.6,0.8, 0);
	controller->SetInitPose(-1.8,2,0.65,-M_PI/5); // demo for dynamic replanning from origin to fixed point

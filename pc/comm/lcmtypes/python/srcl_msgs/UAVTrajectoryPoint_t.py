...
class UAVTrajectoryPoint_t(object):
    __slots__ = ["point_empty", "positions", "velocities", "accelerations", "yaw", "duration"]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack(">fq", self.yaw, self.duration))
    ...
    def _decode_one(buf):
        ...
        self.yaw, self.duration = struct.unpack(">fq", buf.read(12))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x7573d937233fe433) & 0xffffffffffffffff

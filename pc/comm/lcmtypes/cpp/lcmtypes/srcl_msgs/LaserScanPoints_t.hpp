...
#ifndef __srcl_msgs_LaserScanPoints_t_hpp__
#define __srcl_msgs_LaserScanPoints_t_hpp__

#include <vector>
#include "lcmtypes/srcl_msgs/Pose_t.hpp"
#include "lcmtypes/srcl_msgs/Point3Df_t.hpp"
...
{
    public:
        srcl_msgs::Pose_t trans_sensor2world;

        int64_t    point_num;

        std::vector< srcl_msgs::Point3Df_t > points;
...
uint64_t LaserScanPoints_t::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0x503d7b918ac7be34LL +
         srcl_msgs::Pose_t::_computeHash(&cp) +
         srcl_msgs::Point3Df_t::_computeHash(&cp);

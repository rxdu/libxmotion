...
public final class Octomap_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(srcl_msgs.Octomap_t.class))
            return 0L;
 
        classes.add(srcl_msgs.Octomap_t.class);
    ...
    public static srcl_msgs.Octomap_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        srcl_msgs.Octomap_t o = new srcl_msgs.Octomap_t();
    ...
    public srcl_msgs.Octomap_t copy()
    {
        srcl_msgs.Octomap_t outobj = new srcl_msgs.Octomap_t();

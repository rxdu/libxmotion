...
public final class Pose_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(srcl_msgs.Pose_t.class))
            return 0L;
 
        classes.add(srcl_msgs.Pose_t.class);
    ...
    public static srcl_msgs.Pose_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        srcl_msgs.Pose_t o = new srcl_msgs.Pose_t();
    ...
    public srcl_msgs.Pose_t copy()
    {
        srcl_msgs.Pose_t outobj = new srcl_msgs.Pose_t();

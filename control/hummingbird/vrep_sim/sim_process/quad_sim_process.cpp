...
//	att_con_input.delta_w_F = pos_con_output.delta_w_F;
	...
	att_con_input.euler_d[0] = 0;
	att_con_input.euler_d[1] = 0;
	att_con_input.euler_d[2] = 10/180*3.15;
...
//	cmd_m_.motor_cmd.ang_vel[3] = 5200;
	...
	cmd_m_.motor_cmd.ang_vel[0] = att_con_output.ang_vel_d[0];
	cmd_m_.motor_cmd.ang_vel[1] = att_con_output.ang_vel_d[1];
	cmd_m_.motor_cmd.ang_vel[2] = att_con_output.ang_vel_d[2];
	cmd_m_.motor_cmd.ang_vel[3] = att_con_output.ang_vel_d[3];

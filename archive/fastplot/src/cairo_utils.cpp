...
CairoWindow::CairoWindow(CallBackFunc_t cairo_cb)
{
    SetupWindowElements();
...
{
    std::string filename("output_png.png");
...
{
    std::string filename("output_svg.svg");
    std::cout << "Output in " << filename << std::endl;
...
{
    std::string filename("output_eps.eps");
    std::cout << "Output in " << filename << std::endl;
...
{
    std::string filename("output_pdf.pdf");
    std::cout << "Output in " << filename << std::endl;
    canvas->SaveToFile(filename, FileType::PDF);
}

void CairoWindow::SetCairoCallback(CallBackFunc_t func)
{

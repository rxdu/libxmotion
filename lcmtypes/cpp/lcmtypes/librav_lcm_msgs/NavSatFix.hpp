...
#ifndef __librav_lcm_msgs_NavSatFix_hpp__
#define __librav_lcm_msgs_NavSatFix_hpp__

#include <lcm/lcm_coretypes.h>

#include "lcmtypes/librav_lcm_msgs/NavSatStatus.hpp"
...
{
    public:
        librav_lcm_msgs::NavSatStatus status;
...
uint64_t NavSatFix::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0x60c5a36268b1a1a0LL +
         librav_lcm_msgs::NavSatStatus::_computeHash(&cp);

...
#ifndef __librav_lcm_msgs_CarRawIMU_t_hpp__
#define __librav_lcm_msgs_CarRawIMU_t_hpp__
...
int CarRawIMU_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int CarRawIMU_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int CarRawIMU_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t CarRawIMU_t::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* CarRawIMU_t::getTypeName()
{
    return "CarRawIMU_t";
}

int CarRawIMU_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int CarRawIMU_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int CarRawIMU_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t CarRawIMU_t::_computeHash(const __lcm_hash_ptr *)
{

...
#ifndef __librav_lcm_msgs_IMU_hpp__
#define __librav_lcm_msgs_IMU_hpp__

#include <lcm/lcm_coretypes.h>

#include "lcmtypes/librav_lcm_msgs/Quaternion.hpp"
#include "lcmtypes/librav_lcm_msgs/Vector3.hpp"
#include "lcmtypes/librav_lcm_msgs/Vector3.hpp"
...
class IMU
{
    public:
        ...
        librav_lcm_msgs::Quaternion orientation;

        double     orientation_covariance[9];

        librav_lcm_msgs::Vector3 angular_velocity;

        double     angular_velocity_covariance[9];

        librav_lcm_msgs::Vector3 linear_acceleration;
...
uint64_t IMU::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0xac2e31fe8e135e97LL +
         librav_lcm_msgs::Quaternion::_computeHash(&cp) +
         librav_lcm_msgs::Vector3::_computeHash(&cp) +
         librav_lcm_msgs::Vector3::_computeHash(&cp);

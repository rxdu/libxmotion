...
public final class Point3Df_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(librav_lcm_msgs.Point3Df_t.class))
            return 0L;
 
        classes.add(librav_lcm_msgs.Point3Df_t.class);
    ...
    public static librav_lcm_msgs.Point3Df_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        librav_lcm_msgs.Point3Df_t o = new librav_lcm_msgs.Point3Df_t();
    ...
    public librav_lcm_msgs.Point3Df_t copy()
    {
        librav_lcm_msgs.Point3Df_t outobj = new librav_lcm_msgs.Point3Df_t();
        outobj.x = this.x;

...
public final class Pose_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(librav_lcm_msgs.Pose_t.class))
            return 0L;
 
        classes.add(librav_lcm_msgs.Pose_t.class);
    ...
    public static librav_lcm_msgs.Pose_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        librav_lcm_msgs.Pose_t o = new librav_lcm_msgs.Pose_t();
    ...
    public librav_lcm_msgs.Pose_t copy()
    {
        librav_lcm_msgs.Pose_t outobj = new librav_lcm_msgs.Pose_t();

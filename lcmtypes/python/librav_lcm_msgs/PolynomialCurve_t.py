...
import librav_lcm_msgs.PolyCurveSegment_t
...
class PolynomialCurve_t(object):
    ...
    __typenames__ = ["int64_t", "librav_lcm_msgs.PolyCurveSegment_t", "int32_t", "librav_lcm_msgs.WayPoint_t", "librav_lcm_msgs.TimeStamp_t", "int64_t", "float"]
    ...
    def __init__(self):
        ...
        self.wp_num = 0
        self.waypoints = []
        self.start_time = librav_lcm_msgs.TimeStamp_t()
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.seg_num):
            assert self.segments[i0]._get_packed_fingerprint() == librav_lcm_msgs.PolyCurveSegment_t._get_packed_fingerprint()
        ...
        assert self.start_time._get_packed_fingerprint() == librav_lcm_msgs.TimeStamp_t._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.segments = []
        for i0 in range(self.seg_num):
            self.segments.append(librav_lcm_msgs.PolyCurveSegment_t._decode_one(buf))
        self.wp_num = struct.unpack(">i", buf.read(4))[0]
        self.waypoints = []
        for i0 in range(self.wp_num):
            self.waypoints.append(librav_lcm_msgs.WayPoint_t._decode_one(buf))
        self.start_time = librav_lcm_msgs.TimeStamp_t._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xb6932b5031a4ffe5+ librav_lcm_msgs.PolyCurveSegment_t._get_hash_recursive(newparents)+ librav_lcm_msgs.WayPoint_t._get_hash_recursive(newparents)+ librav_lcm_msgs.TimeStamp_t._get_hash_recursive(newparents)) & 0xffffffffffffffff

...
% sensor_cor = sensor_info.sensor_pos;
%                 
...
% left_limit = sensor_cor(1:2) + [sin(alpha1) cos(alpha1)] * sensor_info.range
% right_limit = sensor_cor(1:2) + [sin(alpha2) cos(alpha2)] * sensor_info.range
...
% 
% sensor_info.projection_plane_points = [ll_pos; rl_pos; llu_pos; rlu_pos; lll_pos; rll_pos];
